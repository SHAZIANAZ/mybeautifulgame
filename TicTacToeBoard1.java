...
class TicTacToeBoard extends View {
    ...
    public TicTacToeBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.TicTacToeBoard1, 0, 0);

        try {
            gameBoardColor = a.getInteger(R.styleable.TicTacToeBoard1_boardColor, 0);
            XColor = a.getInteger(R.styleable.TicTacToeBoard1_XColor, 0);
            OColor = a.getInteger(R.styleable.TicTacToeBoard1_OColor, 0);
            diagonalColor = a.getInteger(R.styleable.TicTacToeBoard1_winningLineColor, 0);
    ...
    private void drawX(Canvas canvas, int row, int col){
        ...
        canvas.drawLine((float) (col*cellSize + cellSize* 0.4),
                (float) (row*cellSize + cellSize* 0.2),
